...
//initialise the main scene link for the about section
function initMainSceneLinkAbout() {
    //Loading top and bottom half of the cv logo
    ...
    //initialise text
    var textAbout = new THREE.TextGeometry("DER STUDIENGANG", {
        size: 8,
        height: 2,
        curveSegments: 4,
        font: "helvetiker",
    ...
    var centerOffset = -0.55 * (textAbout.boundingBox.max.x - textAbout.boundingBox.min.x);
    ...
    mainSceneLinkAboutTextVolume.userData = {animationNr: 0}
    mainSceneLinkAboutTextVolume.position.set(-1.9 * centerOffset, 0, 0);
    ...
    mainSceneLinkAboutSphere.userData = {animationNr: 0}
...
//this function animates the eye while hovered
...
//this function animates the eye when mouse is leaving the area
